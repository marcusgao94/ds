...
func TestReElection2A(t *testing.T) {
	...
	fmt.Printf("---------------------------- kill server %v\n", leader1)
	fmt.Printf("---------------------------- server %v is dead\n", leader1)
	cfg.checkOneLeader()

	// if the old leader rejoins, that shouldn't
	// disturb the new leader.
	fmt.Printf("----------------re connect server %v\n", leader1)
	fmt.Println("-------------------all servers are live")
	cfg.connect(leader1)
	...
	fmt.Printf("----------------------------kill server %v, %v\n", leader2, (leader2+1)%servers)
	fmt.Printf("----------------------------server %v, %v are dead\n", leader2, (leader2+1)%servers)
	time.Sleep(2 * RaftElectionTimeout)
	cfg.checkNoLeader()

	// if a quorum arises, it should elect a leader.
	fmt.Printf("-----------------------re connect server %v\n", (leader2+1)%servers)
	fmt.Printf("----------------------------server %v are dead\n", leader2)
...
func TestFailAgree2B(t *testing.T) {
	...
	// DPrintf("---------------------------------re connect server %d", (leader + 1) % servers)
